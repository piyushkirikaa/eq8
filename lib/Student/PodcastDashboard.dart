      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return _buildStatusCard(
            ...
            message: "Unable to check device connection status.",
          );
        } else {
          if (snapshot.data) {
            return _buildStatusCard(
              ...
              color: Colors.green,
              title: "Connected",
              message: "Awesome! You're connected. All systems go!",
            );
          } else {
            return _buildStatusCard(
              icon: Icons.wifi_off,
              ...
              title: "Offline",
              message:
                  "Oops! Looks like you're offline. Check your connection and try again.",
            );
          }
        }
      },
