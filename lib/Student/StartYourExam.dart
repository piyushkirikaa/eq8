...
class _StartYourExamState extends State<StartYourExam> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Your test is ready'.toUpperCase(), style: const TextStyle(color: Colors.white),)
      ),
         ...
         child: Column(
           ...
           children: [
                SizedBox(
                  ...
                  child: const Image(image: AssetImage('assets/Images/icons8-approval-64.png')),
                ),
               const Text('Your test is ready!',
                   style: TextStyle(fontWeight: 
                   FontWeight.bold,color: Colors.black,fontSize: 26)),
             Container(
               height: 15     ,
             ),
             const Text('Your customized test has been successfully generated.',
                 ...
                 Container(
                   height: 500,
                   width: MediaQuery.of(context).size.width,
                   decoration: BoxDecoration(borderRadius: BorderRadius.circular(7),color: Colors.grey.shade200),
                     child: Column(
                       children: [
                        Container(
                      ...
                      children: [
                        ListTile(
                          leading: const Icon(Icons.access_time_filled,color: Colors.black),
                           title: const Text('Time allowed',style: TextStyle(color: Colors.grey)),
                           trailing: Text(tutorial['allowed_time'].toString(),
                               ...
                               FontWeight.bold,fontSize: 17)),
                                ...
                                const Divider(),
                                 ListTile(
                                   leading: const Icon(Icons.message_rounded,color: Colors.black),
                                   title: const Text('No: of Questions',style: TextStyle(color: Colors.grey)),
                                 ...
                                 ListTile(
                                   leading: const Icon(Icons.message_rounded,color: Colors.black),
                                   title: const Text('Total Marks',style: TextStyle(color: Colors.grey)),
                                ...
                                ListTile(
                                  ...
                                  leading: Container(
                                    ...
                                    child: const Icon(Icons.account_tree_outlined,color: Colors.black),
                                  ),
                                  title: const Text('Select Exam Type',style: TextStyle(color: Colors.grey)),
                          ...
                          child: OutlinedButton(
                            style: ButtonStyle(
                              side: MaterialStateProperty.all<BorderSide>(
                                const BorderSide(color: Colors.purple), // Set the border color to yellow
                              ),
                            ),
                            ...
                            child:  Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text('Start your Test'.toUpperCase(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
  ...
  selectExamType(){
    showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        final text_style = TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white);
        return Container(
          height: 360,
          color: Colors.blue,
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                Text('Select Exam Type'.toUpperCase(), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
                Container(
                  child: Column(
                    children: [
                      ListTile(
                        title: Text('Tutorial Specific', style: text_style),
                        onTap: () {
                          setState(() {
                      ...
                      const Divider(),
                      ListTile(
                        title: Text('Lower Order', style: text_style),
                        onTap: () {
                          setState(() {
                      ...
                      const Divider(),
                      ListTile(
                        title: Text('Medium Order', style: text_style),
                        onTap: () {
                          setState(() {
                      ...
                      const Divider(),
                      ListTile(
                        title: Text('Higher Order', style: text_style),
                        onTap: () {
                          setState(() {
  ...
  startExam(response){
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Test(tutorial: widget.tutorial, examConfig: response['data'],)),
    );
  }
