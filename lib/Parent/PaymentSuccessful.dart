...
class _PaymentSuccessfulState extends State<PaymentSuccessful> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          Image.asset("assets/Images/BG/bg_payment_success.png", fit: BoxFit.fill,),
          ...
          const SizedBox(height: 10,),
          const Center(child: Text("The payment has been done successfully.", style: TextStyle(fontSize: 16),)),
          ...
          Container(
            ...
            child: OutlinedButton(
              ...
              child: Text("Go To Dashboard".toUpperCase(), style: const TextStyle(color: Colors.black)),
            ),
          ),
        ],
      ),
